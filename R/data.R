...
#' \item{balanced_after}{Same as `balanced_before`, only for after balancing. This should alwyas be be `TRUE`.}
...
#' Constants for machine data files
#'
#' A string list containing values for features of machine data files.
#'
#' @format A string list with `r length(machine_constants)` entries.
#' \describe{
#' \item{efficiency_tab_name}{The name of the machine data efficiency tab. Default is "FIN_ETA".}
#' }
#'
#' @examples
#' machine_constants
